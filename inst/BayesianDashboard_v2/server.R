  ...
  results_combined <- reactive({
    ...
    output$output_by_grade <- renderUI({
      list(
        ...
        HTML('<p><strong>To learn more</strong> about how this dashboard works, you can review this <a target="_blank" href="https://edtechrce.org/static/pdf/05.02a%20Impact%20Estimation%20Technical%20Appendix.pdf">technical appendix.</a></p>'))
    })
